...
import os
from pages import home, login, register, account, settings, sensor, pump, pump_detail, sensor_data, documentation, predict_data, esp_flash, planting_log
...
def display_page(pathname, session_data):
    ...
    # '/sensor_data' route removed to hide the sensor data page (access by direct URL is no longer served)
        ...
        if is_authenticated and is_admin == False:
            ...
            page = login.layout
    elif pathname == '/planting-log':
        if is_authenticated and is_admin == False:
            page = planting_log.layout
        else:
            page = login.layout
